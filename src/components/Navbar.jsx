      ...
      <div ref={ref} className={`sidebar ${showSidebar && "show-sidebar"}`}>
        ...
        <div
          className={`sidebar-sub-menu ${
            showSidebarSubMenu &&
            subSidebarValue === "menu" &&
            "show-sidebar--sub-menu"
          }`}
        >
...
const Navbar = () => {
  ...
  useEffect(() => {
    if (showMobMenu) document.body.style.overflow = "hidden";
    ...
    <header id="header">
      {isMd ? (
        <nav className="mobile">
          <div
            className={`nav-reward text-uppercase ${
              hideReward && "hide-nav-reward"
            }`}
          >
            All new flavors available
          </div>
          <div className="nav-logo-section">
            <div
              className={`menu-btn-wrapper ${showMobMenu && "active"}`}
              onClick={() => {
                setShowMobSubMenu(false);
          ...
          <div className="mob-menu-container">
            <div className={`mob-menu ${showMobMenu && "show-mob-menu"}`}>
              <ul className="nav-links-section">
                ...
                <li className="d-flex justify-content-between w-100 align-items-center">
                  ...
                  {/* <button
                    className="btn p-0"
                    onClick={() => handleSubMenu("location")}
                  >
                    <BsChevronRight className="nav-icon p-0" />
                  </button> */}
                </li>
            ...
            <div
              className={`mob-sub-menu ${
                showMobSubMenu && subMenuValue === "Shop" && "show-mob-sub-menu"
              }`}
            >
        ...
        <nav className="desktop">
          ...
          <ul className={`nav-links-section ${hideLinks && "hide-nav-links"}`}>
            <li
              className="nav-hover"
              onMouseEnter={() => handleDesktopHoverMenu(true, "Shop")}
              onMouseLeave={() => handleDesktopHoverMenu(false, "")}
            >
              <Link
                to="/shop"
                onClick={() => handleDesktopHoverMenu(false, "")}
              >
                Menu
              </Link>
            </li>
            ...
            <li
              className="nav-hover"
              //   onMouseEnter={() => handleDesktopHoverMenu(true, "location")}
              //   onMouseLeave={() => handleDesktopHoverMenu(false, "")}
            >
              <Link
                to="/locations"
          ...
          <div
            className="desktop-hover-menu-wrap"
            onMouseEnter={() => handleDesktopHoverMenu(true, "Shop")}
            onMouseLeave={() => handleDesktopHoverMenu(false, "")}
          >
            <div
              className={`desktop-hover-menu ${
                showDesktopMenu &&
                showDesktopValue === "Shop" &&
                "show-desktop-menu"
              }`}
            >
          ...
          <div
            className="desktop-hover-menu-wrap location-hover-wrap"
            onMouseEnter={() => handleDesktopHoverMenu(true, "location")}
            onMouseLeave={() => handleDesktopHoverMenu(false, "")}
          >
            <div
              className={`desktop-hover-menu location-hover ${
                showDesktopMenu &&
                showDesktopValue === "location" &&
                "show-desktop-menu"
              }`}
            >
              <Link to="/location">Franchising</Link>
          ...
          <div
            className={`sidebar-wrap ${showSidebar && "sidebar-wrap--show"}`}
          >
            <DesktopSideBar
