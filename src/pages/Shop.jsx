...
const Shop = () => {
  return (
    <div className="mb-5 mobile-section2">
      <div className="bg-danger bg-opacity-10 text-center py-5">
        ...
        <p className="pt-3 w-50 m-auto fs-6 fw-normal">
          Our order minimum is 4 pints. But after that it's up to you. Our boxes
          are designed to neatly hold up to 6, 9, or 18 pints.
        </p>
      </div>
      <div className="">
          ...
          <div className="filter-sort-component">
            <div className="filter-wrap d-flex align-items-center">
              ...
              <div className="btn-group">
                ...
                <ul className="dropdown-menu">
                  ...
                  <li>
                    <DropdownCheckbox label={"Dairy-Free"} value="dairy" />
                  </li>
                  <li>
                    <DropdownCheckbox label={"Fall"} value="fall" />
                  </li>
                  <li>
                    <DropdownCheckbox label={"Gluten-Free"} value="gluten" />
                  </li>
                  <li>
                    <DropdownCheckbox label={"New Arrival"} value="new" />
                  </li>
                  <li>
                    <DropdownCheckbox label={"Top Sellers"} value="top" />
                  </li>
                </ul>
              </div>
            </div>
            <div className="sort-menu d-flex justify-content-between align-items-center gap-5">
              <div className="select-btn d-flex align-items-center">
                <span className="" style={{whiteSpace: 'nowrap'}}>Sort by:</span>
                <select
              ...
              <h3 style={{whiteSpace: 'nowrap'}}>{shop_card.length + " products"}</h3>
            </div>
          </div>
