            ...
            <div className='join-head--grid flex-column-reverse flex-md-row text-md-start text-center py-4 m-0 d-flex justify-content-center align-items-center'>
                <div className='join-content-wrap p-md-5 p-3'>
                    <div className='d-flex flex-column m-auto p-3'>
                        <h2 className='fw-bold fs-1 text-uppercase'>Lorem's Team</h2>
                        <p className='my-3 fs-6 fw-semibold'>It takes a community to make and share ice creams the way we do. We truly believe our differences are our strengths. It’s about each of us bringing our awesomeness in — our whole selves. And together we make something greater than the sum of our parts.</p>
